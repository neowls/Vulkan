...
namespace GraphicsPipeline
{
    ...
    {
        auto vertShaderCode = VulkanUtils::readFile(vectShaderPath);
        auto fragShaderCode = VulkanUtils::readFile(fragShaderPath);

        VkShaderModule vertShaderModule = VulkanUtils::createShaderModule(vertShaderCode);
        VkShaderModule fragShaderModule = VulkanUtils::createShaderModule(fragShaderCode);
